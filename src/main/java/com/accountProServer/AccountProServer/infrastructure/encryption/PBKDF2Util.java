package com.accountProServer.AccountProServer.infrastructure.encryption;
...
public class PBKDF2Util {
    ...
    public boolean authenticate(String attemptedPassword, String encryptedPassword)
        ...
        // 用相同的盐值对用户输入的密码进行加密
        String encryptedAttemptedPassword = getEncryptedPassword(attemptedPassword, generateSalt());
